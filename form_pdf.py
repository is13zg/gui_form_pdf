...
def draw_grid(c, a4_width, a4_height, width_pts, height_pts, separation_pts, margin_pts, linewidth):
    if separation_pts > 0:
        # Вертикальные линии
        current_x = margin_pts
        while current_x <= a4_width - margin_pts:
        ...
        current_y = a4_height - margin_pts
        while current_y >= 0:
            c.setStrokeColor(black)
            c.setLineWidth(linewidth)
